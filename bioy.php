    ...
    function bbioy_create($atts){ ?>
        ...
        <?php endif //End Col ?>
         ...
         <?php setlocale(LC_ALL ,"en_EN"); date_default_timezone_set('America/Los_Angeles'); 
            ...
            if (file_exists(bioy_path.'xml/360-reading-plan-en.xml')) {
                $xml = simplexml_load_file(bioy_path.'xml/360-reading-plan-en.xml');
            } else {
         ...
         <?php setlocale(LC_ALL ,"ro_RO"); date_default_timezone_set('America/Los_Angeles'); 
            ...
            //Check for XML, if exsit Include XML File
            if (file_exists(bioy_path.'xml/360-reading-plan-en.xml')) {
                $xml = simplexml_load_file(bioy_path.'xml/360-reading-plan-ro.xml');
